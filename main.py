                    ...
                    if i1 != "День" and i1 != "change":
                        ...
                        if '1 подгруппа' in data_new['Расписание'][i][i1]:
                            if temp_data_new['1 подгруппа']['Кабинет'] != temp_data_old['1 подгруппа']['Кабинет']:
                                change[i][i1]['1 подгруппа']['Кабинет'] = f"{temp_data_old['1 подгруппа']['Кабинет']} -> {temp_data_new['1 подгруппа']['Кабинет']}"
                                change[i]['change'] = 'true'
                                temp_change = True

                            if temp_data_new['1 подгруппа']['Наименование'] != temp_data_old['1 подгруппа']['Наименование']:
                                change[i][i1]['1 подгруппа']['Наименование'] = f"{temp_data_old['1 подгруппа']['Наименование']}\n -> \n{temp_data_new['1 подгруппа']['Наименование']}"
                                change[i]['change'] = 'true'
                                temp_change = True

                            if temp_data_new['1 подгруппа']['Преподаватель'] != temp_data_old['1 подгруппа']['Преподаватель']:
                                change[i][i1]['1 подгруппа']['Преподаватель'] = f"{temp_data_old['1 подгруппа']['Преподаватель']}\n -> \n{temp_data_new['1 подгруппа']['Преподаватель']}"
                                change[i]['change'] = 'true'
                                temp_change = True
                            ...
                            if temp_data_new['2 подгруппа']['Кабинет'] != temp_data_old['2 подгруппа']['Кабинет']:
                                change[i][i1]['2 подгруппа'][
                                    'Кабинет'] = f"{temp_data_old['2 подгруппа']['Кабинет']} -> {temp_data_new['2 подгруппа']['Кабинет']}"
                                change[i]['change'] = 'true'
                                temp_change = True
                            ...
                            if temp_data_new['2 подгруппа']['Наименование'] != temp_data_old['2 подгруппа'][
                                'Наименование']:
                                change[i][i1]['2 подгруппа'][
                                    'Наименование'] = f"{temp_data_old['2 подгруппа']['Наименование']}\n -> \n{temp_data_new['2 подгруппа']['Наименование']}"
                                change[i]['change'] = 'true'
                                temp_change = True
                            ...
                            if temp_data_new['2 подгруппа']['Преподаватель'] != temp_data_old['2 подгруппа'][
                                'Преподаватель']:
                                change[i][i1]['2 подгруппа'][
                                    'Преподаватель'] = f"{temp_data_old['2 подгруппа']['Преподаватель']}\n -> \n{temp_data_new['2 подгруппа']['Преподаватель']}"
                                change[i]['change'] = 'true'
                                temp_change = True
...
async def test():
    data_old = {'Обновлено': '09.05.2024 21:09', 'Расписание': {'08.05.2024': {'День': 'Ср', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '401', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Лек)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '10.00-11.40'}, '3': {'Кабинет': '303', 'Наименование': 'Стандартизация, сертификация и техническое документоведение (Пр)', 'Преподаватель': 'Тигова Алена Юрьевна', 'Время': '12.00-13.40'}, '4': {'1 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Клевако Станислав Валентинович', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '313', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Клевако Станислав Валентинович', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '313', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '16.00-17.40'}}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '09.05.2024': {'День': 'Чт', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '3': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '4': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '5': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '10.05.2024': {'День': 'Пт', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '312333', 'Наименование': 'Правовое обеспеч. проф. деятельности (Лек)', 'Преподаватель': 'Шапошников Андрей Юрьевич', 'Время': '10.00-11.40'}, '3': {'Кабинет': '123123', 'Наименование': 'Правовое обеспеч. проф. деятельности (Лек)', 'Преподаватель': 'Шапошников Андрей Юрьевич', 'Время': '12.00-13.40'}, '4': {'1 подгруппа': {'Кабинет': '32131233333', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Клевако Станислав Валентинович', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '123123', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Клевако Станислав Валентинович', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '16.00-17.40'}}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '11.05.2024': {'День': 'Сб', '1': {'Кабинет': '203', 'Наименование': 'Менеджмент в профессиональной деятельности (Тек. аттест.)', 'Преподаватель': 'Грабовецкий Дмитрий Сергеевич', 'Время': '8.00-09.40'}, '2': {'Кабинет': '206', 'Наименование': 'Менеджмент в профессиональной деятельности (Пр)', 'Преподаватель': 'Грабовецкий Дмитрий Сергеевич', 'Время': '10.00-11.40'}, '3': {'Кабинет': '401', 'Наименование': 'Менеджмент в профессиональной деятельности (Лек)', 'Преподаватель': 'Грабовецкий Дмитрий Сергеевич', 'Время': '12.00-13.40'}, '4': {'Кабинет': '401', 'Наименование': 'Экономика отрасли (Лек)', 'Преподаватель': 'Грабовецкий Дмитрий Сергеевич', 'Время': '14.00-15.40'}, '5': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '12.05.2024': {'День': 'Вс', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '3': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '4': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '5': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '13.05.2024': {'День': 'Пн', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '3': {'Кабинет': '311', 'Наименование': 'Стандартизация, сертификация и техническое документоведение (Пр)', 'Преподаватель': 'Тигова Алена Юрьевна', 'Время': '12.00-13.40'}, '4': {'Кабинет': '313', 'Наименование': 'Стандартизация, сертификация и техническое документоведение (Пр)', 'Преподаватель': 'Тигова Алена Юрьевна', 'Время': '14.00-15.40'}, '5': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '14.05.2024': {'День': 'Вт', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '3': {'1 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '12.00-13.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '12.00-13.40'}}, '4': {'1 подгруппа': {'Кабинет': '322', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '322', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '16.00-17.40'}}, '6': {'1 подгруппа': {'Кабинет': '322', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '17.50-19.30'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '17.50-19.30'}}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '15.05.2024': {'День': 'Ср', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'1 подгруппа': {'Кабинет': '313', 'Наименование': 'МДК.02.02 Инструментальные средства разработки программного обеспечения (Пр)', 'Преподаватель': 'Куликова Марина Евгеньевна', 'Время': '10.00-11.40'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '10.00-11.40'}}, '3': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '12.00-13.40'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.02.02 Инструментальные средства разработки программного обеспечения (Пр)', 'Преподаватель': 'Куликова Марина Евгеньевна', 'Время': '12.00-13.40'}}, '4': {'1 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Клевако Станислав Валентинович', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Клевако Станислав Валентинович', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '16.00-17.40'}}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '16.05.2024': {'День': 'Чт', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '10.00-11.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '10.00-11.40'}}, '3': {'1 подгруппа': {'Кабинет': '304', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '12.00-13.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '12.00-13.40'}}, '4': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.05.03 Тестирование информ. систем (Пр)', 'Преподаватель': 'Мартынцов Евгений Сергеевич', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '304', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '304', 'Наименование': 'МДК.05.03 Тестирование информ. систем (Тек. ат. 1 подгр.)', 'Преподаватель': 'Мартынцов Евгений Сергеевич', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '16.00-17.40'}}, '6': {'1 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '17.50-19.30'}, '2 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '17.50-19.30'}}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '17.05.2024': {'День': 'Пт', '1': {'1 подгруппа': {'Кабинет': '313', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '8.00-09.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '8.00-09.40'}}, '2': {'Кабинет': 'спорт. зал', 'Наименование': 'Физ. культура (Пр)', 'Преподаватель': 'Крылова Лариса Викторовна', 'Время': '10.00-11.40'}, '3': {'Кабинет': '401', 'Наименование': 'Стандартизация, сертификация и техническое документоведение (Лек)', 'Преподаватель': 'Тигова Алена Юрьевна', 'Время': '12.00-13.40'}, '4': {'1 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '16.00-17.40'}}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '18.05.2024': {'День': 'Сб', '1': {'Кабинет': '206', 'Наименование': 'Правовое обеспеч. проф. деятельности (Пр)', 'Преподаватель': 'Шапошников Андрей Юрьевич', 'Время': '8.00-09.40'}, '2': {'Кабинет': '206', 'Наименование': 'Правовое обеспеч. проф. деятельности (Тек. аттест.)', 'Преподаватель': 'Шапошников Андрей Юрьевич', 'Время': '10.00-11.40'}, '3': {'1 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '12.00-13.40'}, '2 подгруппа': {'Кабинет': '304', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '12.00-13.40'}}, '4': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '5': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '19.05.2024': {'День': 'Вс', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '3': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '4': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '5': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '6': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '20.05.2024': {'День': 'Пн', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'1 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.02.02 Инструментальные средства разработки программного обеспечения (Пр)', 'Преподаватель': 'Куликова Марина Евгеньевна', 'Время': '10.00-11.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '10.00-11.40'}}, '3': {'1 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.02.02 Инструментальные средства разработки программного обеспечения (Зач 1 подгр)', 'Преподаватель': 'Куликова Марина Евгеньевна', 'Время': '12.00-13.40'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '12.00-13.40'}}, '4': {'Кабинет': '401', 'Наименование': 'Экономика отрасли (Лек)', 'Преподаватель': 'Грабовецкий Дмитрий Сергеевич', 'Время': '14.00-15.40'}, '5': {'1 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '313', 'Наименование': 'МДК.05.03 Тестирование информ. систем (Пр)', 'Преподаватель': 'Мартынцов Евгений Сергеевич', 'Время': '16.00-17.40'}}, '6': {'1 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '17.50-19.30'}, '2 подгруппа': {'Кабинет': '313', 'Наименование': 'МДК.05.03 Тестирование информ. систем (Тек. ат. 2 подгр.)', 'Преподаватель': 'Мартынцов Евгений Сергеевич', 'Время': '17.50-19.30'}}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}, '21.05.2024': {'День': 'Вт', '1': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '2': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}, '3': {'Кабинет': '313', 'Наименование': 'Стандартизация, сертификация и техническое документоведение (Дифф. зачет)', 'Преподаватель': 'Тигова Алена Юрьевна', 'Время': '12.00-13.40'}, '4': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '14.00-15.40'}, '2 подгруппа': {'Кабинет': '309', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '14.00-15.40'}}, '5': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '16.00-17.40'}, '2 подгруппа': {'Кабинет': '312', 'Наименование': 'МДК.06.01 Внедрение информационных систем (Пр)', 'Преподаватель': 'Русских Владимир Витальевич', 'Время': '16.00-17.40'}}, '6': {'1 подгруппа': {'Кабинет': '303', 'Наименование': 'МДК.06.02 Инженерно-техническая поддержка сопровождения информационных систем (Пр)', 'Преподаватель': 'Саютин Владимир Николаевич', 'Время': '17.50-19.30'}, '2 подгруппа': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': '17.50-19.30'}}, '7': {'Кабинет': '', 'Наименование': '', 'Преподаватель': '', 'Время': ''}}}}

    data_new = await StudentsSchedule("cg34.htm", "ИСП-9.11").get_data_file

    await StudentsSchedule("cg34.htm", "ИСП-9.11").check_change(data_old, data_new)
